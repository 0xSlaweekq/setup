...
alias supd="sudo apt-get update && sudo apt-get -y upgrade && sudo apt-get -y --fix-broken install && sudo apt-get -y autoremove && sudo apt-get -y autoclean  && flatpak uninstall --unused"
