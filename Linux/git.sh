...
alias dstart="docker-compose -f ./docker-compose.* up -d"
alias dres="docker-compose down && clear && docker-compose up"
alias dstop="docker-compose -f ./docker-compose.* down -v && docker-compose -f ./docker-compose.* rm -sfv"
alias dstopall="docker-compose down --rmi=all -v --remove-orphans && docker rmi $(docker images -a -q)"
alias dreb="docker-compose -f ./docker-compose.* down -v && docker-compose -f ./docker-compose.* rm -sfv && docker-compose -f ./docker-compose.* up -d"
